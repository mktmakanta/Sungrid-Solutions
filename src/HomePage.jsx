  ...
  return (
    <>
      <section className="relative p-6 font-inter md:mt-8 lg:mt-16 lg:pl-32  lg:pb-10 lg:grid grid-cols-2">
        <div className=" font-semibold lg:text-left lg:mt-6 md:space-y-8 lg:space-y-4">
          <h6 className=" font-medium text-amber-600 lg:font-normal mt-10 md:text-xl uppercase">
          ...
          <div className="my-6 md:mx-8 lg:mx-0">
            <button className="bg-amber-600 md:mx-2 hover:bg-amber-500 lg:mx-0 text-white rounded-md md:text-lg md:py-4 md:px-10 lg:py-2 lg:px-6 font-normal mx-2 py-2 px-5">
              Get a Quote
            </button>

            <button className="border md:mx-2 hover:bg-amber-500 border-amber-600 md:py-4 md:px-10 md:text-lg lg:py-2 lg:px-6  text-amber-600 hover:text-white font-normal rounded-md py-2 px-5">
              See our Works
            </button>
          </div>
        </div>
